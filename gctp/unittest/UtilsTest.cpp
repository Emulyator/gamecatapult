...
//CUPPA:decl=+
  void testQuadFunc() {
	  ...
	  CPPUNIT_ASSERT(quadprog(1)==2);
	  CPPUNIT_ASSERT(quadprog(2)==6);
	  CPPUNIT_ASSERT(quadprog(3)==22);
	  CPPUNIT_ASSERT(quadlocalpos(0)==Point2C(0, 0));
	  CPPUNIT_ASSERT(quadlocalpos(6)==Point2C(2, 1));
	  CPPUNIT_ASSERT(quadlocalpos(33)==Point2C(1, 4));
	  CPPUNIT_ASSERT(quadlocalpos(57)==Point2C(5, 6));
	  CPPUNIT_ASSERT(quadlocalpos(67)==Point2C(9, 1));
	  CPPUNIT_ASSERT(quadlocalidx(Point2C(0, 0))==0);
	  CPPUNIT_ASSERT(quadlocalidx(Point2C(2, 1))==6);
...
/*	  CPPUNIT_ASSERT(octpos(6)==Point3(2, 1));
  ...
  void testAllocMap() {
	  ...
	  am.reset();
	  idx[0] = am.alloc(1);
	  CPPUNIT_ASSERT(idx[0] == 2);
	  idx[1] = am.alloc(1);
	  CPPUNIT_ASSERT(idx[1] == 3);
	  idx[2] = am.alloc(1);
	  CPPUNIT_ASSERT(idx[2] == 4);
	  idx[3] = am.alloc(1);
	  CPPUNIT_ASSERT(idx[3] == 5);
	  idx[4] = am.alloc(1);
	  CPPUNIT_ASSERT(idx[4] == 0);
	  am.free(idx[3]);
	  CPPUNIT_ASSERT(am.isFree(idx[3]));
	  idx[3] = am.alloc(2);
	  CPPUNIT_ASSERT(idx[3] == 18);
	  idx[4] = am.alloc(3);
	  CPPUNIT_ASSERT(idx[4] == 1+21+52);
