========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : audiotest
========================================================================


AppWizard が生成した audiotest には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには audiotest を構成している各ファイルの概要説明が含まれています。
...
audiotest.h
    ...
    みます） をインクルードし、また CAudiotestApp アプリケーションクラスを宣
    言します。

audiotest.cpp
    このファイルは CAudiotestApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\audiotest.ico
    ...
    ルです。このアイコンはリソース ファイル audiotest.rc によってインクルード
    されます。
...
audiotestDlg.h, audiotestDlg.cpp - ダイアログ
    これらのファイルは CAudiotestDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な audiotest.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) audiotest.pch 
