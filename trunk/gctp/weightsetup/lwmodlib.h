/*
======================================================================
Modeler helper Library
Copyright 2002,  NewTek, Inc.

lwmodlib.h

Definitions and prototypes helper functions. Code based on Ernie 
Wright's previous work on modlib.
====================================================================== */
...
int csPlugin( char *module, char *_class, char *name, char *username );
...
const char *mgGetColorVMap(LWSurfaceID surf);
void mgSetColorVMap(LWSurfaceID surf, const char *vmapName, int type);
...
LWPntID meAddPointInterp( double *coord, int npoints, const LWPntID *ptarray,
   double *weight );
LWPolID meAddPoly( LWID type, LWPolID proto, const char *surfname, int npoints,
   LWPntID *ptarray );
LWPolID meAddCurve(const char *surfname, int npoints, const LWPntID *ptarray, int flags );
LWPolID meAddFace (const char *surfname, int npoints, const LWPntID *ptarray);
...
EDError meSetPolySurface( LWPolID id, const char *surfname );
EDError meSetPolyPoints( LWPolID id, int npoints, const LWPntID *ptarray );
...
EDError meSetPointVMap( LWPntID id, LWID vmapid, const char *vmapname,
   int nval, float *val );
EDError meSetPointVPMap( LWPntID id, LWPolID polid, LWID type, const char *vmapname,
   int nval, float *val );
