...
namespace gctp {
	...
	public:
		...
		CStr(detail::CStrImpl * p, bool delete_guard = false) : Pointer<detail::CStrImpl>(p)
		{
		...
		static CStr hold(const char *str) { return new detail::CStrImpl(str, true); }
	};
	...
	public:
		TempCStr(const char *str) : Dummy(str, false), CStr(&member, true)
		{
		}
	};
